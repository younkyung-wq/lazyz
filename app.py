...
function drawGuide(g,W,H){ g.save(); g.strokeStyle='rgba(0,220,255,0.95)'; g.lineWidth=1.2; g.beginPath(); g.ellipse(W/2,H*0.32,W*0.28,H*0.27,0,0,Math.PI*2); g.stroke(); g.strokeRect(W*0.06,H*0.80,W*0.88,H*0.13); g.restore(); }

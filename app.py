...
<style>
*{margin:0;padding:0;box-sizing:border-box;font-family:'Pretendard',-apple-system,sans-serif;}
body{background:#eee;height:892px;overflow:hidden;color:#222;}
.wrap{display:flex;flex-direction:row;height:892px;}
.panel{width:300px;flex-shrink:0;height:892px;min-height:0;background:#fff;border-left:1px solid #e5e5e5;order:2;padding:22px 20px;display:flex;flex-direction:column;gap:14px;overflow-y:auto;}
.panel>*{flex-shrink:0;}
